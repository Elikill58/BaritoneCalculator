...
import eli.baritone.api.pathing.calc.IPathFinder;
...
import eli.baritone.api.utils.PathCalculationResult;
...
public abstract class AbstractNodeCostSearch implements IPathFinder, Helper {
     ...
     */
    protected static final double[] COEFFICIENTS = {1.5, 2, 2.5, 3, 4, 5, 10, 1000};
    ...
    protected Optional<IPath> bestSoFar(boolean logInfo, int numNodes) {
        ...
        for (int i = 0; i < COEFFICIENTS.length; i++) {
            if (bestSoFar[i] == null) {
            	logDebug("[AbsNodeCostSearch] Cannot find bestSoFar for " + i);
                continue;
            }
