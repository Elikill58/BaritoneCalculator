...
package eli.baritone.api.pathing.goals;

import java.util.ArrayList;
import java.util.Iterator;

import eli.baritone.api.nms.block.BlockPos;
import eli.baritone.api.utils.SettingsUtil;
...
public class GoalNear implements Goal, IGoalRenderPos {
    ...
    public double heuristic() {// TODO less hacky solution
        ...
        ArrayList<Double> maybeAlwaysInside = new ArrayList<>(); // see pull request #1978
        ...
        Iterator<Double> it = maybeAlwaysInside.iterator();
        while (it.hasNext()) {
            double inside = it.next();
